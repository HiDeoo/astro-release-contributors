 ...
 *      https://github.com/withastro/astro/commit/c7157e69774a1c9eb685285ca21f1cf78f3551c2 for Astro 6.4.0.
 *   2. Append `.patch` at the end of the URL, e.g.
 *      https://github.com/withastro/astro/commit/c7157e69774a1c9eb685285ca21f1cf78f3551c2.patch
 *   3. Copy the `Date` from the third line of the patch file, e.g.
 *      `Date: Thu, 28 May 2026 02:56:53 -0700` and paste it below.
 */
export const SinceDate = new Date('Thu, 28 May 2026 02:56:53 -0700')
