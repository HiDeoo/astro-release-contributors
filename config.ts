 ...
 *      https://github.com/withastro/astro/commit/f55ba4caca7c587555da86e3211ae1f1b3407c5f for Astro 7.0.0.
 *   2. Append `.patch` at the end of the URL, e.g.
 *      https://github.com/withastro/astro/commit/f55ba4caca7c587555da86e3211ae1f1b3407c5f.patch
 *   3. Copy the `Date` from the third line of the patch file, e.g.
 *      `Date: Mon, 22 Jun 2026 03:07:45 -0700` and paste it below.
 */
export const SinceDate = new Date('Mon, 22 Jun 2026 03:07:45 -0700')
